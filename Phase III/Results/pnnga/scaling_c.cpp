...
{
	vector<REAL> prOrigMin, prOrigMax;
	vector<REAL> prNormMin, prNormMax;
...
//		pNormParam->prOrigMin.resize(nLen);
//		pNormParam->prOrigMax.resize(nLen);
//		pNormParam->prNormMin.resize(nLen);
//		pNormParam->prNormMax.resize(nLen);
		pNormParam->prOrigMin.assign( prOrigMin, prOrigMin+nLen );
		pNormParam->prOrigMax.assign( prOrigMax, prOrigMax+nLen );
		pNormParam->prNormMin.assign( prNormMin, prNormMin+nLen );
		pNormParam->prNormMax.assign( prNormMax, prNormMax+nLen );
