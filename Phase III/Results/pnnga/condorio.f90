...
!	ret = Copy_File( '..\mod2.bas', 'mod2.bas' );
!	ret = Copy_File( '..\mod2.bcf', 'mod2.bcf' );
!	ret = Copy_File( '..\mod2.wel', 'mod2.wel' );
!	ret = Copy_File( '..\rt3d2.ssm', 'rt3d2.ssm' );
!	ret = Copy_File( '..\rt3d2.btn', 'rt3d2.btn' );
