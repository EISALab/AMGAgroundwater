...
!	arrNichFlags = (/1, i=1, nVarCount/)
	...
	allocate( sgaParam%arrReliabsInj(max(sgaParam%nPopSize/20,3)) )
...
implicit none
	...
	deallocate( sgaParam%arrCostsInj, sgaParam%arrCostStdsInj, sgaParam%arrViolsInj, sgaParam%arrViolStdsInj, sgaParam%arrReliabsInj )
	...
	deallocate( sgaParam%arrMoments, sgaParam%arrMomentIds, sgaParam%arrReliabs )
