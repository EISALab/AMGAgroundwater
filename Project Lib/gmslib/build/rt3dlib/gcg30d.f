...
C--STORE MAXIMUM CHANGE VALUE AND LOCATION
      ...
      JCOLMN = IJ - (IROW-1)*NCOL
        ...
        LRCH(3,ITP) = JCOLMN
C
C      WRITE(*,1111) ITO,LITP,CHANGE,KLAYER,IROW,JCOLMN ********* COMMENTED OUT BY MEGHNA BABBAR, 23 SEP 2001
C 1111 FORMAT(1X,'Outer Iter.',I3,'  Inner Iter.',I3,
C     &  ':  Max. DC =',G12.4,'  [K,I,J]',3I5)
C
C--CHECK CONVERGENCE ......
