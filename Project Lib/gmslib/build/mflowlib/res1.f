...
C2------RESERVOIR OPTIONS
    ...
    2   FORMAT(5I10)
        ...
        lloc=1                                                  !emrl ff
        call URWORD(line,LLOC,ISTART,ISTOP,2,nres,R,IOUT,in)    !emrl ff
        call URWORD(line,LLOC,ISTART,ISTOP,2,irescb,R,IOUT,in)  !emrl ff
        call URWORD(line,LLOC,ISTART,ISTOP,2,nresop,R,IOUT,in)  !emrl ff
        call URWORD(line,LLOC,ISTART,ISTOP,2,irespt,R,IOUT,in)  !emrl ff
        call URWORD(line,LLOC,ISTART,ISTOP,2,npts,R,IOUT,in)    !emrl ff
      endif  !emrl ff
