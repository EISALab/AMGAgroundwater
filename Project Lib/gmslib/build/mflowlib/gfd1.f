     ...
     1     LCTOP,LCSC2,IN,ISS,NCOL,NROW,NLAY,IOUT,IGFDCB,ifrefm)
C
...
C2------PRINTING OR UNIT# FOR RECORDING CELL-BY-CELL FLOW TERMS)
    ...
    2   FORMAT(2I10)
        ...
        lloc=1                                                   !emrl ff
        call URWORD(line,LLOC,ISTART,ISTOP,2,iss,R,IOUT,in)      !emrl ff
        call URWORD(line,LLOC,ISTART,ISTOP,2,igfdcb,R,IOUT,in)   !emrl ff
      endif !emrl ff
...
C3A-----READ LAYER TYPE CODES.
   50 if (ifrefm.eq.0) then   !emrl ff
   ...
   51   FORMAT(40I2)
        ...
        lloc=1                                                       !emrl ff
        do i=1,nlay                                                  !emrl ff
          call URWORD(line,LLOC,ISTART,ISTOP,2,laycon(i),R,IOUT,in)  !emrl ff
        enddo                                                        !emrl ff
      endif  !emrl ff
