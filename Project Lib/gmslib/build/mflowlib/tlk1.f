...
C4------SAVING AND READING RESTART INFORMATION
    8 if (ifrefm.eq.0) then  !emrl ff
        READ(IN,10) NUMC,ITLKCB,NTM1,ITLKSV,ITLKRS
   10   FORMAT(8I10)
      else   !emrl ff
        read(in,'(a)') line                                     !emrl ff
        lloc=1                                                  !emrl ff
        call URWORD(line,LLOC,ISTART,ISTOP,2,numc,R,IOUT,in)    !emrl ff
        call URWORD(line,LLOC,ISTART,ISTOP,2,itlkcb,R,IOUT,in)  !emrl ff
        call URWORD(line,LLOC,ISTART,ISTOP,2,ntm1,R,IOUT,in)    !emrl ff
        call URWORD(line,LLOC,ISTART,ISTOP,2,itlksv,R,IOUT,in)  !emrl ff
        call URWORD(line,LLOC,ISTART,ISTOP,2,itlkrs,R,IOUT,in)  !emrl ff
      endif  !emrl ff
