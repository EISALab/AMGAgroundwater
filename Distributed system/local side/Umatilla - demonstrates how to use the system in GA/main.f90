...
implicit none
	...
	g_nFields = count_nonblank_lines( 'moments_numbers.txt' )
...
!	sgaParam%nPopSize = 4
	...
	sgaParam%nMaxGens = 80
!	sgaParam%nPopSize = 10
!	sgaParam%nMaxGens = 2
	sgaParam%nMaxDangleGens = 40
...
!	sgaParam%nSamples = 2
	...
	sgaParam%bSeedingBits = .false.
	sgaParam%bSeedingVars = .false.
	sgaParam%flSeeding = 'seedvar.txt'
...
!		call ReadANGAParam( sgaParam, buf )
	...
	sgaParam%rMutateProb = 1/sgaParam%nPopSize
