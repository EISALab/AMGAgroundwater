...
typedef bool (*FUNCJOB)(int nId, CClientSession* pSession, void* pParam);
...
public:
	...
	bool Launch( CClientSession* pSession );		//launch the job on the host object.
};
...
public:
	...
	void RouteJobs( CClientManager* pManager );
