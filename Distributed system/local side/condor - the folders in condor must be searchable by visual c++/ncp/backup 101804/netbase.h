...
public:
	...
	int ReceiveFrom(void* lpBuf, int nBufLen, string& rSocketAddress, UINT& rSocketPort, int nFlags = 0);
	...
	bool GetPeerName(string& rPeerAddress, UINT& rPeerPort);
	bool GetPeerName(SOCKADDR* lpSockAddr, int* lpSockAddrLen);
	bool GetPeerName(SOCKADDR_IN* lpSockInAddr);

	bool GetSockName(string& rSocketAddress, UINT& rSocketPort);
