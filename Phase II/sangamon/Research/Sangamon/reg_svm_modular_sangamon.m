...
function [errors] = reg_svm_modular_sangamon
...
gate_w = region_svm_train_gate( regs, pn, tn, train_cluster, vp, vt, test_cluster );
tp = region_svm_modular_predict( regs, gate_w, [vp; vt] );%, test_cluster );
...
for i=2:n_networks
    ...
    p_o = region_modular_predict( regs, gate_w, [vv_i; vv_o] );
